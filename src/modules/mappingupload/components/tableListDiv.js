...
export const MappingTableListDiv = ({ props, columns, data, Actions, fn, dataFetched, setHeight, getIndex, filterBoxNone, rightBox, centerBox, callHeightFunc, paddingShort, getWidth, actionClass }) => {
    ...
    return (
        <div {...getTableProps()} className="table reactTableComm" style={{ width: getWidth }}>
            ...
            <div {...getTableBodyProps()} ref={tbodyRef} className="rowGroupContent">
                {(data.length === 0 && dataFetched) ? <p style={{ paddingLeft: "45%", paddingTop: "20%" }}>No Data Found...</p> :
                    <FixedSizeList
